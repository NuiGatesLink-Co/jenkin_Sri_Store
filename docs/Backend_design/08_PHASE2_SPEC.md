...
| # | | บล็อก |
|---|---|---|
| Q1 | **ticket ข้อความไทย (F10)** — agent ร่าง 2–3 ตัวเลือกต่อข้อความ เจ้าของเลือก ลง `02 §8.1`: ป้าย "รอ owner" · แถบ Degraded/Syncing · "เปิดอยู่แล้ว" · ถามโหลดรุ่นใหม่ · ช่องเหตุผล void · ส่งใหม่/ทิ้ง/ตรวจแล้ว · ชื่อ 2 แท็บ · ชื่อ 5 kind ของรายการตรวจ · ป้าย "ไม่ได้นับเงิน" · หน้าตั้ง PIN + PIN ซ้ำรหัสผ่าน · แถบขอล็อกอินจริง · ปุ่มออนไลน์เท่านั้น · เครื่องยังไม่ seed · retire มี op ค้าง/บังคับ · code ใหม่ `DOC_NUMBER_REQUIRED` `DOC_NUMBER_INVALID` `VOID_NEEDS_ONLINE` `CLIENT_ID_REUSED` `DEVICE_HAS_UNSYNCED_OPS` | slice 0c — **ไม่บล็อก merge spec** |
