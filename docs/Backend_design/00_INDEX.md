...
| ⭐ [`08_PHASE2_SPEC.md`](08_PHASE2_SPEC.md) | **สเปกเฟส 2** (2026-09-15, #240/#243) — state machine Online/Degraded/Syncing/Conflict, รายการ op ที่เข้าคิว/ออนไลน์เท่านั้น, `POST /sync/push`, เลข RC/CN ที่เครื่อง `pos` ออก, PIN ออฟไลน์, void ออฟไลน์, reconciliation, PWA, ความพร้อม production บน `mob04`, ลำดับ slice, คำถามที่ต้องให้เจ้าของตอบ | **ทุกคนก่อนหยิบ ticket เฟส 2** |
...
| 7 | **production host** | ✅ ปิด 2026-09-15 (#240 D15) — **`mob04` เป็น production สภาพแวดล้อมเดียว** (ในมหาวิทยาลัย) · cutover ร้านจริงเป็นเฟสถัดไป · ข้อความเดิม: ~~🔴 ใหม่ — เฟส 1 รันบน VM คณะเพื่อ**สาธิตเท่านั้น** ต้องเลือกเครื่องจริงก่อนงาน `q4`~~ |
