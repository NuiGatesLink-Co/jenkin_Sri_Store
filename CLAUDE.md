...
balance to `num` straight into a second local row. **AC3 stays open until #30** sums cash
settlements by `shift_id`. Read `docs/handoff_log/lane-a-24-credit-payments.md` before #30.
